            ...
            <main>
                <div class="section-success d-flex align-item-center pt-5">
                    <div class="col text-center">
                        <img src="{{ url('frontend/images/img_success.png')}} " alt="" class="img-successcheckout">
                    <h3 class="pt-3">TRANSAKSI KAMU BERHASIL</h3>
                    <p>
                        Cek Status Pembayaranmu di halaman sebelumnya
