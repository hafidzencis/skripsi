            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('simpanan-cetak-semua')}}"  class="btn btn-sm btn-primary shadow-sm mb-4"><i
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('simpanan-cetak-total-pernama')}}"  class="btn btn-sm btn-primary shadow-sm mb-4"><i
                                class="fas fa-download fa-sm text-white-50"></i> Laporan
                            </a>
                        </div>
                    </div>
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('simpanan-cari-nama-laporan')}} "  class="btn btn-sm btn-primary shadow-sm mb-4"><i
                                class="fas fa-download fa-sm text-white-50"></i> Laporan
                            </a>
                        </div>
                    </div>
