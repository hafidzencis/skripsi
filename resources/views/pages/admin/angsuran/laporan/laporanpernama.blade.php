...
<html lang="en">
    <head>
        ...
        <title>Semua Angsuran oleh {{$name}}</title>
    </head>
    <body>

        <h1> Semua Angsuran oleh {{$name}} </h1>
        ...
        <h1> Semua Angsuran Lunas Filter dengan Angsuran Pokok oleh {{$name}}</h1>
